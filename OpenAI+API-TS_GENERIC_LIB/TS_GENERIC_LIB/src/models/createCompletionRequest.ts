...
export const createCompletionRequestSchema: Schema<CreateCompletionRequest> = object(
  {
    model: ['model', string()],
    ...
    logprobs: ['logprobs', optional(nullable(number()))],
    echo: ['echo', optional(nullable(boolean()))],
    stop: ['stop', optional(nullable(string()))],
    presencePenalty: ['presence_penalty', optional(nullable(number()))],
    frequencyPenalty: ['frequency_penalty', optional(nullable(number()))],
    bestOf: ['best_of', optional(nullable(number()))],
